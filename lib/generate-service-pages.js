...
module.exports = function generateServicePages (fs, gatherer, utils) {
  ...
  for (const plugin of pluginList) {
    ...
    for (const service of services) {
      ...
      ctx.plugin = plugin
      ctx.service = service
      ctx.hasSchema = Object.prototype.hasOwnProperty.call(ctx.service, 'schema') && _.isObject(ctx.service.schema) && Object.prototype.hasOwnProperty.call(ctx.service.schema, 'properties')
      if (ctx.hasSchema) {
